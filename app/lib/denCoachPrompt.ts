...
- Do NOT assume intent. Score only observable behavior.
...
Den Defenders sells AND installs custom security products.
...
INVESTIGATION:
7) Asked or recapped why they called
